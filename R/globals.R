...
utils::globalVariables(c(
     ...
     "emdat_cyclone_active", "emdat_cyclone_prob", "emdat_cyclone_prob_12w_max",
     "drought_active", "drought_prob", "spei_roll", "precip_sum_12w", "precip_sum_24w",
     "wind_speed_10m_max", "region_f", "iso_code_f",
     "ENSO3", "ENSO3_anom", "ENSO3_clim_mean", "ENSO3_clim_sd",
