...
lock_python_env <- function() {
    ...
    # Set and lock environment variable to the non-normalized venv exec: uv venvs
    # symlink bin/python to a shared interpreter, so normalizePath() would resolve away the venv.
