...
#'
#' This function generates a JSON/HDF5/YAML configuration file to be used as transmission model simulation parameters.
...
#'        These proportion fields are provided for analysis convenience but are not required by the transmission model.
...
make_simulation_config <- function(output_file_path = NULL,
                              seed = NULL,
