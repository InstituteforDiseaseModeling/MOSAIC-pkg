...
#'
#' This function creates a facet plot to visualize ENSO and IOD data over time, with separate panels for each variable (IOD, ENSO3, ENSO34, ENSO4). A horizontal line at zero is included to indicate the neutral value, and a vertical line marks the current date, with the date displayed vertically on the left side of the line.
#'
#' @param PATHS A list containing paths where ENSO and IOD data are stored and where output figures should be saved. Typically generated by the `get_paths()` function and should include:
#' \itemize{
...
plot_ENSO_data <- function(PATHS, frequency) {
     ...
     p <-
          ...
          ggplot2::labs(
               title = "Time series of ENSO and IOD",
               x = "",
     ...
     message(glue::glue("ENSO and IOD plot saved to {output_file}"))
