...
#'       \item \code{zeta_1}: Bacterial shedding rate for symptomatic individuals (lognormal distribution)
#'       \item \code{zeta_ratio}: Ratio of symptomatic to asymptomatic shedding (lognormal distribution)
#'     }
#'   }
