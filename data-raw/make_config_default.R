...
#
# v4.4 (2026-06-22): no special-casing needed here for mu_j_baseline. The
# v15.10 ETH-only x0.40 dwell-mismatch stop-gap was REMOVED in priors_default
# v15.14 and replaced by the B1 global chain-factor re-anchor (gamma_1->0.10,
# chi->0.70 in the CFR->mu derivation, scaling every country's mu_j_baseline
# Gamma mean x0.804). Pulling the Gamma mean below carries that global re-anchor
# into config_default by construction. See disease-modeler memory
# project_eth_deaths_cfr_dwell_mismatch and the statistician spec
# MOSAIC-pkg/claude/prior_fix_spec/SPEC_prior_fixes.md.
