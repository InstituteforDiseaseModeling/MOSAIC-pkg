# ---------------------------------------------------------------------------
# make_simulation_epidemic_config_files.R
# ---------------------------------------------------------------------------
# Generate a *toy* simulation parameter configuration for unit‑testing and examples.
...
#
# Usage
#   source("make_simulation_epidemic_config_files.R")
# ---------------------------------------------------------------------------
...
sim_args <- list(
     ...
     kappa            = 1e5,
     decay_days_short  = 3,
     decay_days_long   = 90,         # derived (kept as field for engine consumption)
     decay_shape_1     = 1,
     decay_shape_2     = 1,
...
message("Toy simulation config written to:\n  - ", normalizePath(fp_json))
