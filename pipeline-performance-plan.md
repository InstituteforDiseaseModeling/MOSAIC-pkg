...
**(b) The headline R-squared is reported from the MAE optimum.** The
default objective is `"mae"` (normalised MAE), not R-squared, so the two
need not agree — and at 100k they do not. `summary.json` reports:
