...
`make_simulated_LASER_config_files.R (sim_endemic)` and saved in the
package as **`config_simulation_endemic`**.
...
- `make_simulated_LASER_config_files.R (sim_endemic)` – generator
  script.
