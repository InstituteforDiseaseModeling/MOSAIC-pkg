...
Main functions for running MOSAIC simulations
...
Functions starting with run\_, make\_, or create\_
...
- [`run_mosaic()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/run_mosaic.md)
  [`mosaic_run_defaults()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/run_mosaic.md)
  [`mosaic_sampling_defaults()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/run_mosaic.md)
  [`mosaic_io_presets()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/run_mosaic.md)
  [`run_MOSAIC()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/run_mosaic.md)
...
Estimation and fitting functions
...
- [`download_climate_data()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/download_climate_data.md)
  : Download and Save Climate Data for Multiple Countries (Parquet
  Format, Multiple Models and Variables)
...
- [`get_effective_aic_range_chisq()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/effective_aic_alternatives.md)
  [`get_effective_aic_range_likelihood()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/effective_aic_alternatives.md)
  [`get_effective_aic_range_empirical()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/effective_aic_alternatives.md)
  : Alternative Theoretically-Grounded Approaches for Effective AIC
  Range
- [`get_DMI_forecast()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_DMI_forecast.md)
  : Get DMI (Dipole Mode Index) Forecast Data
- [`get_DMI_forecast_from_json()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_DMI_forecast_from_json.md)
  : Get DMI Forecast from JSON Configuration
- [`get_DMI_historical()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_DMI_historical.md)
  : Download and Process Historical DMI Data
- [`get_ENSO_forecast()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_ENSO_forecast.md)
  : Get ENSO (Niño3, Niño3.4, and Niño4) Forecast Data
- [`get_ENSO_forecast_from_json()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_ENSO_forecast_from_json.md)
  : Get ENSO Forecast from JSON Configuration
- [`get_ENSO_historical()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_ENSO_historical.md)
...
- [`get_climate_forecast()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_climate_forecast.md)
  : Get Climate Forecast Data (Daily)
- [`get_climate_future()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_climate_future.md)
  : Download Future Climate Data for Multiple Locations (One Model at a
  Time)
- [`get_climate_historical()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_climate_historical.md)
  : Get Historical Climate Data
- [`get_col_indices()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_col_indices.md)
...
- [`get_lstm_cv_folds()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/get_lstm_cv_folds.md)
  : Generate Cross-Validation Split for LSTM Environmental Suitability
  Models
...
Gompertz distribution functions
...
- [`bfrs_posterior_to_prior()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/bfrs_posterior_to_prior.md)
...
- [`combine_vaccination_data()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/combine_vaccination_data.md)
  : Combine WHO and GTFCC Vaccination Data
- [`compare_distributions()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/compare_distributions.md)
...
- [`fit_uniform_from_ci()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/fit_uniform_from_ci.md)
  : Fit Uniform Distribution from Mode and 95% Confidence Intervals
- [`format_ess_rate_analysis()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/format_ess_rate_analysis.md)
...
- [`generate_country_grid_n()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/generate_country_grid_n.md)
  : Generate a Grid of Points Within a Country's Shapefile Based on
  Number of Points
- [`generate_test_data_for_ess()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/generate_test_data_for_ess.md)
...
- [`test_beta_fitting()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/test_beta_fitting.md)
  : Test the beta fitting function with vaccine effectiveness parameters
- [`test_gamma_fitting()`](https://institutefordiseasemodeling.github.io/MOSAIC-pkg/reference/test_gamma_fitting.md)
  : Test the gamma fitting function with vaccine effectiveness
  parameters
