...
as transmission model simulation parameters. It validates all input
parameters and, if an output file path is provided, writes the
parameters to a file. The file extension determines which output format
is used:
...
- prop_S_initial:
  ...
  not required by the transmission model.
