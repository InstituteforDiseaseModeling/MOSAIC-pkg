...
# Sum across all locations for total cases per timestep
total_cases <- colSums(cases, na.rm = TRUE)

# Plot 1: Total cases across all locations
png("figures/multi_location_total.png", width = 800, height = 600, res = 120)
plot(total_cases, type = "l", lwd = 2, col = "#009ADE",
     xlab = "Time step",
     ylab = "Total Expected Cases",
     main = "Total Expected Cases Across All Locations")
grid()
dev.off()
cat("Saved: figures/multi_location_total.png\n")

# Plot 2: Grid plot showing each location separately
png("figures/multi_location_grid.png", width = 1200, height = 1200, res = 120)
...
```{r multi-location-total-plot, echo = FALSE, eval = TRUE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("figures/multi_location_total.png")
```

```{r multi-location-grid-plot, echo = FALSE, eval = TRUE, out.width = "100%", fig.align = "center"}
