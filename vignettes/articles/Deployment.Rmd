...
```{r show-setup-script, echo=FALSE, comment='', class.source='bash'}
cat(readLines('../../vm/setup_mosaic.sh'), sep='\n')
```
...
```{r show-minimal-script, echo=FALSE, comment='', class.source='bash'}
cat(readLines('../../vm/setup_mosaic_minimal.sh'), sep='\n')
```
