...
MOSAIC has three installation levels depending on your needs: **Quick Start** (5 min) for running models, **Standard Setup** (15 min) for data processing, and **Developer Setup** (20 min) for contributing code. Most users should start with Quick Start.
