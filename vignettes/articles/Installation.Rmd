...
| Setup | Time | Purpose | Requirements |
|-------|------|---------|--------------|
| **Quick Start** | 5 min | Run pre-configured models | R + internet |
| **Standard Setup** | 15 min | Process data & estimate parameters | R + git + system libraries |
| **Developer Setup** | 20 min | Contribute code & full development | All above + dev tools |
