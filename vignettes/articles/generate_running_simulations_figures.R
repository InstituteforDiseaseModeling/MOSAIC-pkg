...
#   source("vignettes/articles/generate_running_simulations_figures.R")
...
message("Generating Running simulations vignette figures...")
message("This will take a few minutes as simulations run...")
...
model_epidemic <- run_simulation(config = config, seed = 123, quiet = TRUE)
...
model_endemic <- run_simulation(config = config, seed = 123, quiet = TRUE)
...
results <- run_simulation(config, seed = 123, quiet = TRUE)
